...
def test_update_replaces_previous_indexed_state() -> None:
    search = HybridSearch()
...
def test_update_keeps_doc_id_registered() -> None:
    search = HybridSearch()
    search.add("d", "old t", "old c")
...
def test_update_accepts_empty_title_with_non_empty_content() -> None:
    search = HybridSearch()
    search.add("d", "t", "c")
